...
public class Tables extends VerticalLayout implements View {
    ...
    final IndexedContainer normalContainer = ReportEngineUI.generateContainer(200,
            false);
    final IndexedContainer gridContainer = ReportEngineUI.generateContainer(200,
            false);
    final Container hierarchicalContainer = ReportEngineUI.generateContainer(200,
            true);
    ...
    static void configure(Table table, Grid grid, boolean footer,
        ...
        if (footer) {
            ...
            table.setColumnFooter(ReportEngineUI.DESCRIPTION_PROPERTY,
                    "description");
        ...
        table.setColumnExpandRatio(ReportEngineUI.CAPTION_PROPERTY,
                expandRatios ? 1.0f : 0);
        table.setColumnExpandRatio(ReportEngineUI.DESCRIPTION_PROPERTY,
                expandRatios ? 1.0f : 0);
